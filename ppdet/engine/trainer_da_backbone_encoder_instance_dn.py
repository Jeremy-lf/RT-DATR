...
__all__ = ['Trainer_DA_RTDETR_Backbone_Encoder_Instance_DN']


class Trainer_DA_RTDETR_Backbone_Encoder_Instance_DN(Trainer):
                    ...
                    if self.cfg.da_method == 'rtdetr_backbone_encoder_instance_dn':
                        ...
                        outputs_bbox_src, outputs_logit_src, gt_bbox_src, gt_class_src, \
                            dn_out_bboxes_src, dn_out_logits_src, dn_meta_src, gt_score_src, \
                                domain_outs_enc_src, domain_labels_enc_src, masks_src, hs_src, \
                        ...
                        outputs_bbox_tgt, outputs_logit_tgt, gt_bbox_tgt, gt_class_tgt, \
                            dn_out_bboxes_tgt, dn_out_logits_tgt, dn_meta_tgt, gt_score_tgt, \
                                domain_outs_enc_tgt, domain_labels_enc_tgt, masks_tgt, hs_tgt, \
