...
__all__ = ['Trainer_DA_RTDETR_Backbone_Encoder']


class Trainer_DA_RTDETR_Backbone_Encoder(Trainer):
        ...
        for epoch_id in range(self.start_epoch, self.cfg.epoch):
            ...
            for step_id in range(len(self.loader)):
                ...
                with model.no_sync():
                    ...
                    elif self.cfg.da_method == 'o2net_rtdetr_backbone_encoder':
                        ...
                        outputs_bbox_src, outputs_logit_src, gt_bbox_src, gt_class_src, \
                            dn_out_bboxes, dn_out_logits, dn_meta, gt_score_src, \
                                domain_outs_enc_src, domain_labels_enc_src, masks_src, hs_src, \
                                    src_num_denoising, domain_outs_backbone_src, domain_labels_backbone_src = model(data_sup)
                        
                        outputs_bbox_tgt, outputs_logit_tgt, gt_bbox_tgt, gt_class_tgt, \
                            dn_out_bboxes, dn_out_logits, dn_meta, gt_score_tgt, \
                                domain_outs_enc_tgt, domain_labels_enc_tgt, masks_tgt, hs_tgt, \
                                    tgt_num_denoising, domain_outs_backbone_tgt, domain_labels_backbone_tgt = model(data_unsup)
