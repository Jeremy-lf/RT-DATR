...
__all__ = ['Trainer_DA_RTDETR_Backbone_Encoder_Instance']


class Trainer_DA_RTDETR_Backbone_Encoder_Instance(Trainer):
        ...
        for epoch_id in range(self.start_epoch, self.cfg.epoch):
            ...
            for step_id in range(len(self.loader)):
                ...
                with model.no_sync():
                    ...
                    elif self.cfg.da_method == 'o2net_rtdetr_backbone_encoder_instance':
