...
__all__ = ['DA_RTDETRTransformer_Instance']
...
class TransformerDecoderLayer(nn.Layer):
    ...
    def forward(self,
        ...
        if self.training and self.space_align:
            space_query = self.space_attn(space_query, tgt, query_pos_embed)
...
class TransformerDecoder(nn.Layer):
    ...
    def forward(self,
        ...
        return paddle.stack(dec_out_bboxes), paddle.stack(dec_out_logits), paddle.stack(outputs), space_query


@register
class DA_RTDETRTransformer_Instance(nn.Layer):
    ...
    def __init__(self,
        ...
        super(DA_RTDETRTransformer_Instance, self).__init__()
