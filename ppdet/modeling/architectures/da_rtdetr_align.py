...
class DA_RTDETR_Align(BaseArch):
    ...
    def __init__(self,
        ...
        super(DA_RTDETR_Align, self).__init__()
    ...
    def _forward(self):
        ...
        out_transformer = \
        (out_bboxes, out_logits, enc_topk_bboxes, enc_topk_logits, dn_meta, domain_outs, domain_labels, masks, outputs, num_denoising, da_loss_cls, da_loss_loc) = \
        ...
        if self.training:
            out_bboxes, out_logits, gt_bbox, gt_class, \
                dn_out_bboxes, dn_out_logits, dn_meta, _, \
                    domain_outs, domain_labels, masks, outputs, num_denoising, da_loss_cls, da_loss_loc  = self.detr_head(
            ...
            return out_bboxes, out_logits, gt_bbox, gt_class, \
                   dn_out_bboxes, dn_out_logits, dn_meta, None, \
                       domain_outs, domain_labels, masks, outputs, num_denoising, da_loss_cls, da_loss_loc
        else:
