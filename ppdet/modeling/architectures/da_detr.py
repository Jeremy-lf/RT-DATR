...
class DA_DETR(BaseArch):
    ...
    def _forward(self):
        ...
        # DETR Head
        if self.training:
            outputs_bbox, outputs_logit, gt_bbox, gt_class, \
                domain_outs, domain_labels, masks, hs = self.detr_head(out_transformer, body_feats,
                                         self.inputs)
            
            return outputs_bbox, outputs_logit, gt_bbox, gt_class, domain_outs, domain_labels, masks, hs
        else:
