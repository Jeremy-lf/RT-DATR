...
class DA_RTDETR(BaseArch):
    ...
    def _forward(self):
        ...
        out_transformer = \
        (out_bboxes, out_logits, enc_topk_bboxes, enc_topk_logits, dn_meta, domain_outs, domain_labels, masks, outputs, num_denoising) = \
        ...
        if self.training:
            out_bboxes, out_logits, gt_bbox, gt_class, \
                dn_out_bboxes, dn_out_logits, dn_meta, _, \
                    domain_outs, domain_labels, masks, outputs, num_denoising  = self.detr_head(
            ...
            return out_bboxes, out_logits, gt_bbox, gt_class, \
                   dn_out_bboxes, dn_out_logits, dn_meta, None, \
                       domain_outs, domain_labels, masks, outputs, num_denoising
        else:
