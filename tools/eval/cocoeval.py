...
class COCOeval:
    ...
    def computeIoU(self, imgId, catId):
        ...
        # d [n,4] g[m,4] ious [n,m]
        # if len(g) >1:
        def calc_iou(bbox1, bbox2, catId):
            ...
            if catId == 2:
                union = np.minimum(area1,np.squeeze(area2, axis=-1))
            else:
                union = area1 + np.squeeze(area2, axis=-1) - intersect
            return intersect / union

        # ious = maskUtils.iou(d,g,iscrowd)
        ious = calc_iou(d, g, catId)
        return ious
        ...
        for k, k0 in enumerate(k_list):
            ...
            for a, a0 in enumerate(a_list):
                ...
                for m, maxDet in enumerate(m_list):
                    ...
                    # print(e['dtScores'][0:maxDet] for e in E)
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 384], [384, 96 ** 2], [96 ** 2, 1e5 ** 2]]
